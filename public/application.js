...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://giftlistcathyob.herokuapp.com/'
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGifteesForUser = function getGifteesForUser() {
	  api.getGiftees().then(ui.displayGifteesForUser);
	};

	var selectedGiftee = function selectedGiftee(id) {
	  if (lastId !== id) {
	    lastId = id;
	    api.getGifteeDetails(id).then(ui.displayDetailsForGiftee);
	  }
	};

	var updateGifteeData = function updateGifteeData(id) {
	  api.getGifteeDetails(id).then(ui.displayDetailsForGiftee);
	};

	var onCreateGiftee = function onCreateGiftee() {
	  var name = $('.giftee-name-taker').val();
	  var body = {};
	  body.giftee = { "name": name };

	  api.createGiftee(body).then(ui.createNewGiftee);
	  $('.giftee-name-taker').val("");
	};

	var onUpdateNotes = function onUpdateNotes() {
	  ...
	  api.updateNotes({ "note": notes }, lastId).then(ui.notesUpdated).catch(ui.notesNotUpdated);
	};

	var onAddIdea = function onAddIdea() {
	  var idea = {};
	  ...
	  api.createNewIdea({ "idea": idea }).then(ui.addNewIdeaToList).catch(ui.addNewIdeaFail);
	};
	...
	var deleteGiftee = function deleteGiftee(id) {
	  ...
	  api.deleteSelectedGiftee(id).then(getGifteesForUser);
	};
	...
	module.exports = {
	  ...
	  selectedGiftee: selectedGiftee,
	  updateGifteeData: updateGifteeData,
	  getGifteesForUser: getGifteesForUser,
	  onUpdateNotes: onUpdateNotes,
	  onAddIdea: onAddIdea,
	  deleteGiftee: deleteGiftee
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGiftees = function getGiftees() {
	  return $.ajax({
	...
	var getGifteeDetails = function getGifteeDetails(id) {
	  return $.ajax({
	...
	var createGiftee = function createGiftee(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/giftee/',
	    method: 'POST',
	    headers: {
	...
	var updateNotes = function updateNotes(data, id) {
	  return $.ajax({
	...
	var createNewIdea = function createNewIdea(data) {
	  return $.ajax({
	...
	var deleteSelectedGiftee = function deleteSelectedGiftee(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/giftee/' + id,
	    method: 'DELETE',
	    headers: {
	...
	module.exports = {
	  getGiftees: getGiftees,
	  getGifteeDetails: getGifteeDetails,
	  createGiftee: createGiftee,
	  updateNotes: updateNotes,
	  createNewIdea: createNewIdea,
	  deleteSelectedGiftee: deleteSelectedGiftee
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gifteeList = __webpack_require__(15);
	var ideasList = __webpack_require__(35);

	var currentGiftee = null;

	var displayGifteesForUser = function displayGifteesForUser(data) {
	  currentGiftee = null; // added due to displayDetailsForGiftee
	  var events = __webpack_require__(12);
	  $('.giftees-lister').empty();
	  var html = gifteeList({ people: data.giftees });
	...
	var displayDetailsForGiftee = function displayDetailsForGiftee(data) {
	  ...
	  var html = ideasList({ ideas: data.ideas });
	  $('.pending-ideas-holder').empty();
	  $('.pending-ideas-holder').append(html);
	};

	var createNewGiftee = function createNewGiftee(data) {
	  var events = __webpack_require__(12);
	  events.getGifteesForUser();
	};

	var addNewIdeaToList = function addNewIdeaToList(data) {
	  var events = __webpack_require__(12);
	...
	var addNewIdeaFail = function addNewIdeaFail() {
	  $('#idea-message').removeClass('hidden');
	...
	var notesUpdated = function notesUpdated(notes) {
	...
	var notesNotUpdated = function notesNotUpdated(notes) {
	  $('#notes-message').removeClass('hidden');
	...
	module.exports = {
	  displayGifteesForUser: displayGifteesForUser,
	  displayDetailsForGiftee: displayDetailsForGiftee,
	  createNewGiftee: createNewGiftee,
	  addNewIdeaToList: addNewIdeaToList,
	  addNewIdeaFail: addNewIdeaFail,
	  notesUpdated: notesUpdated,
	  notesNotUpdated: notesNotUpdated
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div>\n    <div class=\"giftee-selectable\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <p class=\"giftee-name-style\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</p>\n    </div>\n    <div class=\"giftee-trash-icon trash-giftee\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <span class=\"glyphicon glyphicon-trash\" aria-hidden=\"true\"></span>\n    </div>\n  </div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.people : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div class=\"idea-selectable\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n    <p class=\"idea-style\">"
	    ...
	    + "</li>\n        <li>Source: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.where : stack1), depth0))
	    + "</li>\n        <li>Notes: "
	  ...
	  return "<p class=\"idea-label\">Ideas</p>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.ideas : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
